...
public class LinkedListPassFailTests
{
	...
	/**
	 * Tests to clear the linked list.
	 */
	@Test // test-to-pass
	void testClear()
	{
	...
	/**
	 * Tests to retrieve data from the linked list.
	 */
	@Test // test-to-pass
	void testRetrieve()
	{
	...
	/**
	 * Tests retrieve function to throw exception.
	 */
	@Test // test-to-fail
	void testRetrieveException()
	{
		linkedList.append("a");
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.retrieve(1));
	}
	
	/**
	 * Tests delete function to throw exception.
	 */
	@Test // test-to-fail
	void testDeleteException()
	{
		linkedList.append("a");
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.delete(1));
	}
	
	/**
	 * Tests replace function to throw exception.
	 */
	@Test // test-to-fail
	void testReplaceException()
	{
		linkedList.append("a");
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.replace("b",1));
	}
	
	/**
	 * Tests insert function to throw exception.
	 */
	@Test // test-to-fail
	void testInsertException()
	{
		linkedList.append("a");
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.insert("b", 2));
	}
