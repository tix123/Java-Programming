...
public class ReservationsTab extends TabBase
{
	...
	private class FindReservationsButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			ArrayList<Reservation> reservations = reservationManager.findReservations(searchCodeText.getText(), searchAirlineText
	...
	private class MyListSelectionListener implements ListSelectionListener
	{
		...
		public void valueChanged(ListSelectionEvent e)
		{
			...
			costText.setText(Double.toString(reservationsList.getSelectedValue().getCost()));
	...
	private class UpdateButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			try
			{
				reservationManager.findReservationByCode(codeText.getText()).setName(nameText.getText());
				reservationManager.findReservationByCode(codeText.getText()).setCitizenship(citizenshipText.getText());
				...
				reservationManager.findReservationByCode(codeText.getText()).setActive(active);
